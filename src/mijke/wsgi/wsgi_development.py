"""
WSGI config for mijke_fotografie project.
...
# os.environ["DJANGO_SETTINGS_MODULE"] = "mijke_fotografie.settings"
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "mijke_fotografie.conf.settings_development")
